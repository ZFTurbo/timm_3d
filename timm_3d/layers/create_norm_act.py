...
from .norm_act import BatchNormAct3d, GroupNormAct, LayerNormAct, LayerNormAct3d
from .inplace_abn import InplaceAbn

_NORM_ACT_MAP = dict(
    batchnorm=BatchNormAct3d,
...
_NORM_ACT_REQUIRES_ARG = {
    BatchNormAct3d, GroupNormAct, LayerNormAct, LayerNormAct3d, FilterResponseNormAct2d, InplaceAbn}
