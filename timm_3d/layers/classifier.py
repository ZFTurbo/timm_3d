...
from .adaptive_avgmax_pool import SelectAdaptivePool3d
...
class NormMlpClassifierHead(nn.Module):
    ...
    def __init__(
            ...
            pool_type: str = 'avg',
            drop_rate: float = 0.,
            norm_layer: Union[str, Callable] = 'layernorm3d',
        ...
        linear_layer = partial(nn.Conv3d, kernel_size=1) if self.use_conv else nn.Linear

        self.global_pool = SelectAdaptivePool3d(pool_type=pool_type)
    ...
    def reset(self, num_classes, global_pool=None):
        if global_pool is not None:
            self.global_pool = SelectAdaptivePool3d(pool_type=global_pool)
