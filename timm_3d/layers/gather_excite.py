        ...
        if extra_params:
            ...
            if extent == 0:
                ...
                self.gather.add_module(
                    'conv1', create_conv3d(channels, channels, kernel_size=feat_size, stride=1, depthwise=True))
                if norm_layer:
                ...
                for i in range(num_conv):
                    self.gather.add_module(
                        f'conv{i + 1}',
                        create_conv3d(channels, channels, kernel_size=3, stride=2, depthwise=True))
                    if norm_layer:
