...
from timm_3d.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, OPENAI_CLIP_MEAN, OPENAI_CLIP_STD
from timm_3d.layers import trunc_normal_, AvgPool3dSame, DropPath, Mlp, GlobalResponseNormMlp, \
    LayerNorm3d, LayerNorm, create_conv3d, get_act_layer, make_divisible, to_ntuple
    ...
    def __init__(
        ...
        if stem_type == 'patch':
            ...
            self.stem = nn.Sequential(
                nn.Conv3d(in_chans, dims[0], kernel_size=patch_size, stride=patch_size, bias=conv_bias),
                norm_layer(dims[0]),
            )
            ...
            self.stem = nn.Sequential(
                nn.Conv3d(in_chans, mid_chs, kernel_size=3, stride=2, padding=1, bias=conv_bias),
                nn.Conv3d(mid_chs, dims[0], kernel_size=3, stride=2, padding=1, bias=conv_bias),
                norm_layer(dims[0]),
            )
            stem_stride = 4
...
default_cfgs = generate_default_cfgs({
    ...
    'convnext_tiny.in12k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        crop_pct=0.95, test_input_size=(3, 288, 288, 288), test_crop_pct=1.0),
    ...
    'convnext_atto.d2_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        test_input_size=(3, 288, 288, 288), test_crop_pct=0.95),
    ...
    'convnext_tiny.fb_in22k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        test_input_size=(3, 288, 288, 288), test_crop_pct=1.0),
    ...
    'convnextv2_huge.fcmae_ft_in22k_in1k_512': _cfgv2(
        ...
        hf_hub_id='timm/',
        input_size=(3, 512, 512, 512), pool_size=(15, 15, 15), crop_pct=1.0, crop_mode='squash'),
    ...
    'convnext_base.clip_laion2b_augreg_ft_in12k_in1k': _cfg(
        ...
        input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), crop_pct=1.0),
    ...
    'convnext_large_mlp.clip_laion2b_soup_ft_in12k_in1k_320': _cfg(
        hf_hub_id='timm/',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320, 320), pool_size=(10, 10, 10), crop_pct=1.0),
    ...
    'convnext_base.clip_laiona_augreg_ft_in1k_384': _cfg(
        hf_hub_id='timm/',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 384, 384, 384), pool_size=(12, 12, 12), crop_pct=1.0),
    ...
    'convnext_base.clip_laion2b': _cfg(
        ...
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), crop_pct=1.0, num_classes=640),
    ...
    'convnext_base.clip_laiona_320': _cfg(
        ...
        hf_hub_filename='open_clip_pytorch_model.bin',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320, 320), pool_size=(10, 10, 10), crop_pct=1.0, num_classes=640),
    ...
    'convnext_large_mlp.clip_laion2b_augreg': _cfg(
        ...
        hf_hub_filename='open_clip_pytorch_model.bin',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), crop_pct=1.0, num_classes=768),
    'convnext_large_mlp.clip_laion2b_ft_320': _cfg(
        hf_hub_id='laion/CLIP-convnext_large_d_320.laion2B-s29B-b131K-ft',
        hf_hub_filename='open_clip_pytorch_model.bin',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 320, 320, 320), pool_size=(10, 10, 10), crop_pct=1.0, num_classes=768),
    ...
    'convnext_xxlarge.clip_laion2b_soup': _cfg(
        ...
        hf_hub_filename='open_clip_pytorch_model.bin',
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD,
        input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), crop_pct=1.0, num_classes=1024),
