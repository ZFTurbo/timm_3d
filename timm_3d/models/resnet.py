...
from timm_3d.layers import DropBlock3d, DropPath, AvgPool3dSame, BlurPool3d, GroupNorm, LayerType, create_attn, \
...
def drop_blocks(drop_prob: float = 0.):
    return [
        None, None,
        partial(DropBlock3d, drop_prob=drop_prob, block_size=5, gamma_scale=0.25) if drop_prob else None,
        partial(DropBlock3d, drop_prob=drop_prob, block_size=3, gamma_scale=1.00) if drop_prob else None]
    ...
    def __init__(
        ...
        if replace_stem_pool:
            self.maxpool = nn.Sequential(*filter(None, [
                nn.Conv3d(inplanes, inplanes, 3, stride=1 if aa_layer else 2, padding=1, bias=False),
...
def _ttcfg(url='', **kwargs):
    return _cfg(url=url, **dict({
        'interpolation': 'bicubic', 'test_input_size': (3, 288, 288, 288), 'test_crop_pct': 0.95,
...
def _rcfg(url='', **kwargs):
    return _cfg(url=url, **dict({
        'interpolation': 'bicubic', 'crop_pct': 0.95, 'test_input_size': (3, 288, 288, 288), 'test_crop_pct': 1.0,
...
def _r3cfg(url='', **kwargs):
    return _cfg(url=url, **dict({
        'interpolation': 'bicubic', 'input_size': (3, 160, 160, 160), 'pool_size': (5, 5, 5),
        'crop_pct': 0.95, 'test_input_size': (3, 224, 224, 224), 'test_crop_pct': 0.95,
        'origin_url': 'https://github.com/huggingface/pytorch-image-models', 'paper_ids': 'arXiv:2110.00476',
    }, **kwargs))
...
default_cfgs = generate_default_cfgs({
    ...
    'resnet10t.c3_in1k': _ttcfg(
        ...
        input_size=(3, 176, 176, 176), pool_size=(6, 6, 6), test_crop_pct=0.95, test_input_size=(3, 224, 224, 224),
        first_conv='conv1.0'),
    ...
    'resnet26t.ra2_in1k': _ttcfg(
        ...
        first_conv='conv1.0', input_size=(3, 256, 256, 256), pool_size=(8, 8, 8),
        crop_pct=0.94, test_input_size=(3, 320, 320, 320), test_crop_pct=1.0),
    ...
    'resnet50.a1h_in1k': _rcfg(
        ...
        input_size=(3, 176, 176, 176), pool_size=(6, 6, 6), crop_pct=0.9, test_input_size=(3, 224, 224, 224), test_crop_pct=1.0),
    ...
    'resnet101d.ra2_in1k': _ttcfg(
        ...
        first_conv='conv1.0', input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), crop_pct=0.95,
        test_crop_pct=1.0, test_input_size=(3, 320, 320, 320)),
    ...
    'resnet50.tv2_in1k': _cfg(
        ...
        input_size=(3, 176, 176, 176), pool_size=(6, 6, 6), test_input_size=(3, 224, 224, 224), test_crop_pct=0.965,
        license='bsd-3-clause', origin_url='https://github.com/pytorch/vision'),
    ...
    'resnext101_32x8d.tv2_in1k': _cfg(
        ...
        input_size=(3, 176, 176, 176), pool_size=(6, 6), test_input_size=(3, 224, 224, 224), test_crop_pct=0.965,
        license='bsd-3-clause', origin_url='https://github.com/pytorch/vision'),
    ...
    'ecaresnet26t.ra2_in1k': _ttcfg(
        ...
        first_conv='conv1.0', input_size=(3, 256, 256, 256), pool_size=(8, 8, 8),
        test_crop_pct=0.95, test_input_size=(3, 320, 320, 320)),
    'ecaresnetlight.miil_in1k': _tcfg(
        ...
        test_crop_pct=0.95, test_input_size=(3, 288, 288, 288)),
    'ecaresnet50d.miil_in1k': _tcfg(
        ...
        first_conv='conv1.0', test_crop_pct=0.95, test_input_size=(3, 288, 288, 288)),
    ...
    'ecaresnet200d.untrained': _ttcfg(
        first_conv='conv1.0', input_size=(3, 256, 256, 256), crop_pct=0.95, pool_size=(8, 8, 8)),
    'ecaresnet269d.ra2_in1k': _ttcfg(
        ...
        first_conv='conv1.0', input_size=(3, 320, 320, 320), pool_size=(10, 10, 10), crop_pct=0.95,
        test_crop_pct=1.0, test_input_size=(3, 352, 352, 352)),
    ...
    'seresnextaa101d_32x8d.sw_in12k_ft_in1k_288': _ttcfg(
        hf_hub_id='timm/',
        crop_pct=0.95, input_size=(3, 288, 288, 288), pool_size=(9, 9, 9), test_input_size=(3, 320, 320, 320), test_crop_pct=1.0,
        first_conv='conv1.0'),
    ...
    'seresnextaa201d_32x8d.sw_in12k_ft_in1k_384': _cfg(
        hf_hub_id='timm/',
        interpolation='bicubic', first_conv='conv1.0', pool_size=(12, 12, 12), input_size=(3, 384, 384, 384), crop_pct=1.0),
    'seresnextaa201d_32x8d.sw_in12k': _cfg(
        hf_hub_id='timm/',
        num_classes=11821, interpolation='bicubic', first_conv='conv1.0',
        crop_pct=0.95, input_size=(3, 320, 320, 320), pool_size=(10, 10, 10), test_input_size=(3, 384, 384, 384), test_crop_pct=1.0),
    ...
    'resnetrs50.tf_in1k': _cfg(
        ...
        input_size=(3, 160, 160, 160), pool_size=(5, 5, 5), crop_pct=0.91, test_input_size=(3, 224, 224, 224),
    ...
    'resnetrs101.tf_in1k': _cfg(
        ...
        input_size=(3, 192, 192, 192), pool_size=(6, 6, 6), crop_pct=0.94, test_input_size=(3, 288, 288, 288),
        interpolation='bicubic', first_conv='conv1.0'),
    'resnetrs152.tf_in1k': _cfg(
        ...
        input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), crop_pct=1.0, test_input_size=(3, 320, 320, 320),
        interpolation='bicubic', first_conv='conv1.0'),
    ...
    'resnetrs270.tf_in1k': _cfg(
        ...
        input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), crop_pct=1.0, test_input_size=(3, 352, 352, 352),
        interpolation='bicubic', first_conv='conv1.0'),
    'resnetrs350.tf_in1k': _cfg(
        ...
        input_size=(3, 288, 288, 288), pool_size=(9, 9, 9), crop_pct=1.0, test_input_size=(3, 384, 384, 384),
        interpolation='bicubic', first_conv='conv1.0'),
    'resnetrs420.tf_in1k': _cfg(
        ...
        input_size=(3, 320, 320, 320), pool_size=(10, 10, 10), crop_pct=1.0, test_input_size=(3, 416, 416, 416),
        interpolation='bicubic', first_conv='conv1.0'),
...
def resnetblur18(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    """
    model_args = dict(block=BasicBlock, layers=[2, 2, 2, 2], aa_layer=BlurPool3d)
...
def resnetblur50(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    """
    model_args = dict(block=Bottleneck, layers=[3, 4, 6, 3], aa_layer=BlurPool3d)
...
def resnetblur50d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    """
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 6, 3], aa_layer=BlurPool3d,
        stem_width=32, stem_type='deep', avg_down=True)
...
def resnetblur101d(pretrained: bool = False, **kwargs) -> ResNet:
    ...
    """
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 23, 3], aa_layer=BlurPool3d,
        stem_width=32, stem_type='deep', avg_down=True)
