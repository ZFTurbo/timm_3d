...
from timm_3d.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
from timm_3d.layers import create_conv3d, create_classifier, get_norm_act_layer, GroupNormAct
...
class EfficientNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv_stem = create_conv3d(in_chans, stem_size, 3, stride=2, padding=pad_type)
        ...
        # Head + Pooling
        self.conv_head = create_conv3d(head_chs, self.num_features, 1, padding=pad_type)
...
def _cfg(url='', **kwargs):
    return {
        'url': url, 'num_classes': 1000, 'input_size': (3, 128, 128, 128), 'pool_size': (4, 4, 4),
...
default_cfgs = generate_default_cfgs({
    ...
    'efficientnet_b1.ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        test_input_size=(3, 256, 256, 256), crop_pct=1.0),
    'efficientnet_b2.ra_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 256, 256, 256), pool_size=(8, 8, 8), test_input_size=(3, 288, 288, 288), crop_pct=1.0),
    'efficientnet_b3.ra2_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 288, 288, 288), pool_size=(9, 9, 9), test_input_size=(3, 320, 320, 320), crop_pct=1.0),
    'efficientnet_b4.ra2_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 320, 320, 320), pool_size=(10, 10, 10), test_input_size=(3, 384, 384, 284), crop_pct=1.0),
    'efficientnet_b5.sw_in12k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        input_size=(3, 448, 448, 448), pool_size=(14, 14, 14), crop_pct=1.0, crop_mode='squash'),
    'efficientnet_b5.sw_in12k': _cfg(
        hf_hub_id='timm/',
        input_size=(3, 416, 416, 416), pool_size=(13, 13, 13), crop_pct=0.95, num_classes=11821),
    'efficientnet_b6.untrained': _cfg(
        url='', input_size=(3, 528, 528, 528), pool_size=(17, 17, 17), crop_pct=0.942),
    'efficientnet_b7.untrained': _cfg(
        url='', input_size=(3, 600, 600, 600), pool_size=(19, 19, 19), crop_pct=0.949),
    'efficientnet_b8.untrained': _cfg(
        url='', input_size=(3, 672, 672, 672), pool_size=(21, 21, 21), crop_pct=0.954),
    'efficientnet_l2.untrained': _cfg(
        url='', input_size=(3, 800, 800, 800), pool_size=(25, 25, 25), crop_pct=0.961),
    ...
    'efficientnet_em.ra2_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 240, 240, 240), pool_size=(8, 8, 8), crop_pct=0.882),
    'efficientnet_el.ra_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 300, 300, 300), pool_size=(10, 10, 10), crop_pct=0.904),
    ...
    'efficientnet_cc_b1_8e.untrained': _cfg(input_size=(3, 240, 240, 240), pool_size=(8, 8, 8), crop_pct=0.882),
    ...
    'efficientnet_lite2.untrained': _cfg(
        input_size=(3, 260, 260, 260), pool_size=(9, 9, 9), crop_pct=0.890),
    'efficientnet_lite3.untrained': _cfg(
        input_size=(3, 300, 300, 300), pool_size=(10, 10, 10), crop_pct=0.904),
    'efficientnet_lite4.untrained': _cfg(
        input_size=(3, 380, 380, 380), pool_size=(12, 12, 12), crop_pct=0.922),
    ...
    'efficientnet_b1_pruned.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 240, 240, 240), pool_size=(8, 8, 8),
    ...
    'efficientnet_b2_pruned.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 260, 260, 260), pool_size=(9, 9, 9),
    ...
    'efficientnet_b3_pruned.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 300, 300, 300), pool_size=(10, 10, 10),
    ...
    'efficientnetv2_rw_t.ra2_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 224, 224, 224), test_input_size=(3, 288, 288, 288), pool_size=(7, 7, 7), crop_pct=1.0),
    ...
    'efficientnetv2_rw_s.ra2_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 288, 288, 288), test_input_size=(3, 384, 384, 384), pool_size=(9, 9, 9), crop_pct=1.0),
    'efficientnetv2_rw_m.agc_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 320, 320, 320), test_input_size=(3, 416, 416, 416), pool_size=(10, 10, 10), crop_pct=1.0),
    ...
    'efficientnetv2_l.untrained': _cfg(
        input_size=(3, 384, 384, 384), test_input_size=(3, 480, 480, 480), pool_size=(12, 12, 12), crop_pct=1.0),
    'efficientnetv2_xl.untrained': _cfg(
        input_size=(3, 384, 384, 384), test_input_size=(3, 512, 512, 512), pool_size=(12, 12, 12), crop_pct=1.0),

    'tf_efficientnet_b0.ns_jft_in1k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_efficientnet_b0_ns-c0e6a31c.pth',
        hf_hub_id='timm/',
        input_size=(3, 224, 224, 224)),
    ...
    'tf_efficientnet_b5.ns_jft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 456, 456, 456), pool_size=(15, 15, 15), crop_pct=0.934),
    'tf_efficientnet_b6.ns_jft_in1k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_efficientnet_b6_ns-51548356.pth',
        hf_hub_id='timm/',
        input_size=(3, 528, 528, 528), pool_size=(17, 17, 17), crop_pct=0.942),
    'tf_efficientnet_b7.ns_jft_in1k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_efficientnet_b7_ns-1dbc32de.pth',
        hf_hub_id='timm/',
        input_size=(3, 600, 600, 600), pool_size=(19, 19, 19), crop_pct=0.949),
    'tf_efficientnet_l2.ns_jft_in1k_475': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 475, 475, 475), pool_size=(15, 15, 15), crop_pct=0.936),
    'tf_efficientnet_l2.ns_jft_in1k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_efficientnet_l2_ns-df73bb44.pth',
        hf_hub_id='timm/',
        input_size=(3, 800, 800, 800), pool_size=(25, 25, 25), crop_pct=0.96),
    ...
    'tf_efficientnet_b0.ap_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD, input_size=(3, 224, 224, 224)),
    ...
    'tf_efficientnet_b8.ap_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
        input_size=(3, 672, 672, 672), pool_size=(21, 21, 21), crop_pct=0.954),
    ...
    'tf_efficientnet_lite3.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 300, 300, 300), pool_size=(10, 10, 10), crop_pct=0.904, interpolation='bilinear'),
    'tf_efficientnet_lite4.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 380, 380, 380), pool_size=(12, 12, 12), crop_pct=0.920, interpolation='bilinear'),
    ...
    'tf_efficientnetv2_s.in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 300, 300, 300), test_input_size=(3, 384, 384, 384), pool_size=(10, 10, 10), crop_pct=1.0),
    'tf_efficientnetv2_m.in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 384, 384, 384), test_input_size=(3, 480, 480, 480), pool_size=(12, 12, 12), crop_pct=1.0, crop_mode='squash'),
    ...
    'tf_efficientnetv2_xl.in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
        input_size=(3, 384, 384, 384), test_input_size=(3, 512, 512, 512), pool_size=(12, 12, 12), crop_pct=1.0, crop_mode='squash'),
    ...
    'tf_efficientnetv2_b0.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 192, 192, 192), test_input_size=(3, 224, 224, 224), pool_size=(6, 6, 6)),
    'tf_efficientnetv2_b1.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 192, 192, 192), test_input_size=(3, 240, 240, 240), pool_size=(6, 6, 6), crop_pct=0.882),
    'tf_efficientnetv2_b2.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 208, 208, 208), test_input_size=(3, 260, 260, 260), pool_size=(7, 7, 7), crop_pct=0.890),
    'tf_efficientnetv2_b3.in21k_ft_in1k': _cfg(
        hf_hub_id='timm/',
        mean=IMAGENET_INCEPTION_MEAN, std=IMAGENET_INCEPTION_STD,
        input_size=(3, 240, 240, 240), test_input_size=(3, 300, 300, 300), pool_size=(8, 8, 8), crop_pct=0.9, crop_mode='squash'),
    'tf_efficientnetv2_b3.in1k': _cfg(
        ...
        hf_hub_id='timm/',
        input_size=(3, 240, 240, 240), test_input_size=(3, 300, 300, 300), pool_size=(8, 8, 8), crop_pct=0.904),
