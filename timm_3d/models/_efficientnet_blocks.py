...
from timm_3d.layers import create_conv3d, DropPath, make_divisible, create_act_layer, get_norm_act_layer
...
class ConvBnAct(nn.Module):
    ...
    def __init__(
            ...
            skip=False, act_layer=nn.ReLU, norm_layer=nn.BatchNorm3d, drop_path_rate=0.):
...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(
        ...
        self.conv_pw = create_conv3d(in_chs, out_chs, pw_kernel_size, padding=pad_type)
...
class InvertedResidual(nn.Module):
    ...
    def __init__(
            ...
            norm_layer=nn.BatchNorm3d, se_layer=None, conv_kwargs=None, drop_path_rate=0.):
        ...
        self.conv_pw = create_conv3d(in_chs, mid_chs, exp_kernel_size, padding=pad_type, **conv_kwargs)
        ...
        self.conv_pwl = create_conv3d(mid_chs, out_chs, pw_kernel_size, padding=pad_type, **conv_kwargs)
...
class CondConvResidual(InvertedResidual):
    ...
    def forward(self, x):
        shortcut = x
        pooled_inputs = F.adaptive_avg_pool3d(x, 1).flatten(1)  # CondConv routing
...
class EdgeResidual(nn.Module):
    ...
    def __init__(
            ...
            norm_layer=nn.BatchNorm3d, se_layer=None, drop_path_rate=0.):
        ...
        # Point-wise linear projection
        self.conv_pwl = create_conv3d(mid_chs, out_chs, pw_kernel_size, padding=pad_type)
