...
from timm_3d.layers import Conv3dSame, ScaledStdConv2dSame, CondConv3d, StdConv2dSame
from timm_3d.layers.non_local_attn import BilinearAttnTransform
from timm_3d.layers.pool3d_same import MaxPool3dSame, AvgPool3dSame
from timm_3d.layers.norm_act import (
    BatchNormAct3d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from timm_3d.models.layers that we want to treat as leaf modules go here
# BUT modules from timm_3d.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from timm_3d.layers import InplaceAbn
...
def register_notrace_module(module: Type[nn.Module]):
    """
    Any module not under timm_3d.models.layers should get this decorator if we don't want to trace through it.
    """
