...
from timm_3d.layers import BatchNormAct3d, SyncBatchNormAct, FrozenBatchNormAct2d,\
...
def _freeze_unfreeze(root_module, submodules=[], include_bn_running_stats=True, mode='freeze'):
    ...
    if isinstance(root_module, (
        ...
        raise AssertionError(
            ...
            "`timm_3d.utils.model.freeze_batch_norm_2d` or `timm_3d.utils.model.unfreeze_batch_norm_2d` instead.")
...
def freeze(root_module, submodules=[], include_bn_running_stats=True):
    ...
    Hint: If you want to freeze batch norm ONLY, use `timm_3d.utils.model.freeze_batch_norm_2d`.

    Examples::

        >>> model = timm_3d.create_model('resnet18')
